 ...
 * Anonymous inner class is used to handle the window closing event. An images
 * is used to change the standard application frame icon, and an image is added
 * to the button. Also, it shows how to display the frame in the center of the
 * screen.
 * 
...
public class SimpleSwingGUIe2 extends JFrame implements ActionListener {
	...
	private void setAndLaunch() {
		...
		// Do not pack() the frame - the frame title will not be displayed
		// completely
		// pack();
