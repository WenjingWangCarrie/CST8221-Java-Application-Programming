 ...
 * a a resource locator to indicate the location of the image files (see line 26
 * and line 119)
 * 
 * to change the image of icon in the title bar
 * 
...
public class SimpleSwingGUIe2R extends JFrame implements ActionListener {
	...
	private void setAndLaunch() {
		...
		// The location of the image is specified relative to the location of
		// the class file.
		// In this case the class file and the image in the same location
		// (folder).
		buttonImage = new ImageIcon(getClass().getResource("happy.gif"));
		/* the class called class --> getClass() => to get location of your class
		 * getResource() to get the resource in the location
		 */
		
		
		button = new JButton("A Happy New Semester JButton", buttonImage);
		// Create a keyboard shortcut: Pressing ALT-I will act as a mouse click
		// on the button
		...
		// anonymous inner class which inherits from WindowAdapter and overrides
	...
	/**
	 * The main method.The GUI will have the default Look and Feel - Metal Look
	 * and Feel
	 * 
	 * @param args
	 *            not used
