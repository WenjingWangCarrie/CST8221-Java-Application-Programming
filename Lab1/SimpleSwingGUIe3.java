 ...
 * can be deployed bot as an applet and a desktop application. The example shows
 * how to change the default "Look and Feel" of a Swing GUI application. It
 * shows how to change the standard text font. It shows how to attach mnemonics
 * and tooltips to a button. It uses anonymous inner class to handle the button
...
public class SimpleSwingGUIe3 extends JPanel {
	...
	/**
	 * Sets the GUI. This method is called from within the constructor to
	 * initialize the GUI.
	 */
	...
	private JButton createButton(String buttonName) {
		...
		// !!! Change the font size of the default font - assign1
		button.setFont(new Font(button.getFont().getName(), button.getFont().getStyle(), 20));// resize the font to size 20
		// Set a specific font button.setFont(new Font(Font.SANS_SERIF, Font.PLAIN, 16));
		// set the initial size of the component in most cases it is better to 
		// leave to the UI Manager to determine the preferred size
		...
		button.addActionListener(new ActionListener() { // compare with SimpleSwingGUIe3L class
			@Override
			public void actionPerformed(ActionEvent ae) {
				...
				// now perform another button action: switch to the new look and
				// feel
				try {
					...
					// Normally an error dialog should be displayed here or the
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				// center the frame on the screen. This method was introduced in
				// Java 1.7
