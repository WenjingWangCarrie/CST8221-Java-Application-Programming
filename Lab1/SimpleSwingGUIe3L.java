...
public class SimpleSwingGUIe3L extends JPanel {
	...
	private JButton createButton(String buttonName) {
		...
		button.addActionListener((ActionEvent ae) -> { // instead to write a new event handler, 
													  // it implements Action Listener directly
			++clickCounter;
	...
	public static void main(String[] args) {
		...
		// Lambda expression syntax is used instead of anonymous inner class
		// syntax.
