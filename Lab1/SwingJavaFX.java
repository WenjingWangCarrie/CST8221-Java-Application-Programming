 ...
 * specialized class SwingNode introduce in JavaFX 8. The content to be
 ...
 * https://docs.oracle.com/javase/8/javafx/interoperability-tutorial/swing-fx-
...
public class SwingJavaFX extends Application {
	 ...
	 * 
	 * @param swingNode
	 *            the JavaFX node embedding the Swing GUI
	 */
	...
	/**
	 * This class is used to create a Swing GUI. It is the same class used in
	 * Lab 1 Example 3.
	 */
	private class SwingGUI extends JPanel {
		// default serial version ID - Swing components implement the
		...
		/**
		 * Creates a button and registers (adds) an ActionListener to process
		 * the events generated by the button.
		 * 
		 * @param buttonName
		 *            the button label.
		...
		private JButton createButton(String buttonName) {
			...
			button.setFont(new Font(button.getFont().getName(), button.getFont().getStyle(), 20));// resize
																									// the
																									// font
																									// to
																									// size
			...
			// in most cases it is better to leave to the UI Manager to
			// determine the preferred size
			button.setPreferredSize(new Dimension(button.getText().length() * 15, 40));
			// Create a keyboard shortcut: Pressing ALT-I will act as a mouse
			// click on the button
			...
			button.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent ae) {
					...
					// now perform another button action: switch to the new look
					// and feel
					try {
						...
						// printStackTrace() is used only for debugging
						// purposes.
						// Normally an error dialog should be displayed here or
