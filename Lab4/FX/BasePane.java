...
public class BasePane extends Application {
	 ...
	 * 
	 * @Override // Override the start method in the Application class public
	 * void start(Stage primaryStage) { // Create a scene and place it in the
	 * stage Scene scene = new Scene(getPane("Programming with JavaFX"), 450,
	 * 200); primaryStage.setTitle("BaseDemo"); // Set the stage title
