...
public class CheckBoxFrame extends JFrame {
	...
	/**
	 * Private inner class for ItemListener event handling JCheckBox generates
	 * also an ActionEvent which means that you can implement an ActionListener
	 * instead of ItemListener
	 */
